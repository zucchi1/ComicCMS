...
$routes = [
    ...
    // 追加のルートをここに定義
    'titleList' => [
        "route" => 'titleListController.php', // 新規ユーザー
        "login_require" => true,
    ],
    'titleAdd' => [
        "route" => 'titleAddController.php', // 新規ユーザー
        "login_require" => true,
    ],
    'titleEdit' => [
        "route" => 'titleEditController.php', // 新規ユーザー
        "login_require" => true,
    ],
    'chapterList' => [
        "route" => 'chapterListController.php', // 新規ユーザー
        "login_require" => true,
    ],
    'chapterAdd' => [
        "route" => 'chapterAddController.php', // 新規ユーザー
        "login_require" => true,
    ],
    'chapterEdit' => [
        "route" => 'chapterEditController.php', // 新規ユーザー
        "login_require" => true,
    ]
];
